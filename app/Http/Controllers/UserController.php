...
class UserController extends Controller
{
    ...
    public function create_user()
    {
        ...
        $user = User::create([
            ...
            'type_user' => 4, // Type par défaut pour les opérateurs
            'role' => 'user',
            'status' => 0, // Inactif jusqu'au paiement
            'created_at' => now(),
            'updated_at' => now(),
        ]);
        ...
        // Rediriger vers la page d'accès au compte
        return redirect()->route('home')->with('success', 'Compte créé avec succès. Veuillez compléter votre abonnement.');
    }
