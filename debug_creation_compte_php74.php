...
echo "=== SCRIPT DE DEBUGGING - CRÉATION DE COMPTE ET ANNULATION PAIEMENT (PHP 7.4) ===" . PHP_EOL;
...
try {
    ...
    if ($auth->attempt($credentials)) {
        ...
        if ($verifAbonnement == null) {
            ...
            echo "⚠️  Un abonnement est encore détecté" . PHP_EOL;
        }
