    ...
    <div class="service1 service-page-service sp">
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="service1-box">
                        <div class="image overlay-anim">
                            <img src="/frontoffice/images/formules/basic.png" alt="Formule Basique" style="width: 100%; height: 100%; object-fit: cover;">
                        </div>
                        <div class="hover-area">
                            ...
                            <div class="heading1-w">
                                <h4><a href="{{ route('service-basic') }}">Formule Basique</a></h4>
                                <div class="space16"></div>
                                <p>
                                    La formule basique offre un accès gratuit aux fonctionnalités essentielles de la plateforme.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                {{-- Carte archivée - Page Options temporairement inaccessible --}}
                {{-- <div class="col-lg-3 col-md-6">
                    <div class="service1-box">
                        <div class="image overlay-anim">
