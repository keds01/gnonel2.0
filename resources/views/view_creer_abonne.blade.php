...
@php
    $abonnementOffre = $offre ? \Illuminate\Support\Facades\DB::table('abonnement')->where('libelle', $offre)->first() : null;
@endphp
                                <center>
                                    <h4 class="mb-4"><span
                                            class="formule">{{ $abonnementOffre ? $abonnementOffre->prix : '' }}{{ $abonnementOffre ? $abonnementOffre->monnaie : '' }}</span>
                                    </h4>
                                </center>
                                <center>
                                    <h4 class="mb-4"><span class="formule2">{{ $offre ?? 'Abonnement' }}</span> </h4>
                                </center>
