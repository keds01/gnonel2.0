        ...
        <div id="sidebar-menu">
            ...
            <ul id="side-menu">
                ...
                @elseif(Auth::user()->type_user == 4 || Auth::user()->type_user == 5)
                    ...
                    @if ($abon != null)
                        {{-- Bloc Spécifications techs EN PREMIER (uniquement si abonnement actif) --}}
                        <li>
                            <a href="#sidebarTechnicalSpecs" data-bs-toggle="collapse">
                                <i data-feather="codesandbox"></i>
                                <span> Spécifications techs </span>
                    ...
                    @if ($abon != null && $abon->base_four == 1)
                        <!-- Base fournisseurs EN DEUXIÈME (uniquement si abonnement actif et base_four = 1) -->
                        <li>
                    ...
                    @if ($abon != null)
                        <!-- Références techs EN TROISIÈME (uniquement si abonnement actif) -->
                        <li>
                            <a href="#sidebarTechnicalReferences" data-bs-toggle="collapse">
                                <i data-feather="file"></i>
                                <span> Références techs </span>
