...
@section('content')
    ...
    $secteurold = \Illuminate\Support\Facades\DB::table('secteuractivite')
        ->where('idsecteuractivite', $updates[0]->secteuractivite_id)
        ->first();
    ?>
                ...
                <div class="col-12 col-md-12 col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>Modifier l'opérateur économique </h4>
                        </div>
                        <form method="POST" action="{{ route('add_update_operateur', $updates[0]->id) }}">
                            @csrf
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('mail') is-invalid @enderror"
                                                name="mail" value="{{ $updates[0]->mail }}" id="nom">
                                            @error('mail')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                name="num_fiscal" value="{{ $updates[0]->num_fiscal }}" id="num_fiscal">
                                            @error('num_fiscal')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="secteur" required>
                                                @if ($secteurold != null)
                                                    <option value="{{ $updates[0]->secteuractivite_id }}" selected="true">
                                                ...
                                                @foreach ($secteur_activites as $secteur_activite)
                                                    @if ($updates[0]->secteuractivite_id != $secteur_activite->idsecteuractivite)
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <textarea id="description" type="text" name="description" class="form-control @error('image') is-invalid @enderror"
                                                id="description">{{ $updates[0]->des_operateur }}</textarea>

                                        </div>
                                    </div>
                                    <div class="col" id="jfe" <?php if ($updates[0]->id_pays!=1) {
                                     ?> style="display: none;"
                                        <?php         }?>>
                                        <div class="form-group">
                                            ...
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="type"
                                                    id="typeoperateur" value="1" <?php if ($updates[0]->jfe == true) {
                                                        echo 'checked';
                                                    } ?>>
                                            ...
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="type"
                                                    id="typeautorite" value="0" <?php if ($updates[0]->jfe == false) {
                                                        echo 'checked';
                                                    } ?>>
    ...
    @if (Session::has('update_no'))
        <script>
            alert('la modification a échouée, reprendre')
        </script>
    @endif
@endsection
