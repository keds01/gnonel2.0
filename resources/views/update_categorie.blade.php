...
@section('content')
    <div class="container-fluid">
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">Modifier un type de marché</li>
                        </ol>
                    </div>
                    <h4 class="page-title">Modifier un type de marché</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
        ...
        <div class="row">
            <div class="col-4">
                <form method="POST" class="new-form" action="{{ route('add_update_categorie', $updates[0]->id) }}">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="header-title">Modifier un type de marché</h4>
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" maxlength="3"
                                    ...
                                    value="{{ $updates[0]->code_categorie }}" id="code">
                                @error('code')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('nom') is-invalid @enderror" name="nom"
                                    value="{{ $updates[0]->nom_categorie }}" id="nom">
                                @error('nom')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <table id="datatable-buttons" class="table table-striped dt-responsive nowrap w-100">
                            ...
                            <tbody>
                                @foreach ($categories as $categorie)
                                    <tr
                                        @if ($categorie->nom_categorie == $updates[0]->nom_categorie) class="table-primary" style="background-color:#ffedcc !important;font-weight: bold;" @endif>
