        ...
        <div class="container">
            ...
            <div class="row">
                <div class="service7-slider" data-aos="fade-up" data-aos-duration="700">
                    ...
                    <div class="single-slider">
                        <div class="image">
                            <img src="/frontoffice/images/formules/basic.png" alt="Formule Basique">
                            <a href="{{ route('service-basic') }}" class="hover-icon"><i
                                    class="fa-solid fa-arrow-right"></i></a>
                        </div>
                        <div class="hover-area">
                            <div class="icon">
                            ...
                            <div class="heading">
                                <h3><a href="{{ route('service-basic') }}">Formule "Basique"</a></h3>
                            </div>
                        </div>
                    </div>
                </div>
