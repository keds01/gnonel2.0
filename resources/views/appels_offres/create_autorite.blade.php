        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">Publier un appel d'offre</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="alert alert-info">
                            <strong>Autorité Contractante :</strong> {{ $autorite->raison_social }}
                        </div>

                        <form method="POST" action="{{ route('autorite.offre.store') }}">
                            @csrf
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('reference') is-invalid @enderror"
                                            name="reference" value="{{ old('reference') }}" id="reference" required>
                                        @error('reference')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('secteur') is-invalid @enderror" name="secteur" required>
                                            ...
                                            @foreach ($secteur_activites as $secteur_activite)
                                                <option value="{{ $secteur_activite->idsecteuractivite }}" {{ old('secteur') == $secteur_activite->idsecteuractivite ? 'selected' : '' }}>
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('libelle') is-invalid @enderror"
                                            name="libelle" value="{{ old('libelle') }}" id="libelle" required>
                                        @error('libelle')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="date"
                                            ...
                                            name="date_publication" value="{{ old('date_publication', date('Y-m-d')) }}"
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="datetime-local"
                                            ...
                                            name="date_cloture" value="{{ old('date_cloture') }}" id="date_cloture" required>
                                        @error('date_cloture')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('mode') is-invalid @enderror" name="mode" required>
                                            ...
                                            @foreach ($modes as $mode)
                                                <option value="{{ $mode->id }}" {{ old('mode') == $mode->id ? 'selected' : '' }}>
                                                    {{ $mode->libelle }}</option>
                                            @endforeach
                                        </select>
                                        @error('mode')
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('source') is-invalid @enderror"
                                            name="source" value="{{ old('source', $autorite->raison_social) }}" id="source" required>
                                        @error('source')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('contact') is-invalid @enderror"
                                            name="contact" value="{{ old('contact') }}" id="contact" required
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <button type="submit" class="btn btn-primary">
                                        <i class="fas fa-save"></i> Publier l'appel d'offre
                                    </button>
