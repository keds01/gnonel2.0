                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="card">
                        <div class="card-header">
                            <h4>Modifier un model</h4>
                        </div>
                        <form method="POST" action="{{ route('add_update_model', $updates[0]->id) }}"
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('libelle') is-invalid @enderror"
                                        name="libelle" value="{{ $updates[0]->libelle_modele }}" id="libelle">
                                    @error('libelle')
                                ...
                                <div class="form-group">
                                    <label for="fichier">Fichier (écraser le fichier existant)</label>
