...
// Check if element exists before initializing ApexCharts
var salesAnalyticsElement = document.querySelector("#sales-analytics");
if (salesAnalyticsElement) {
    (chart = new ApexCharts(salesAnalyticsElement, options)).render();
}

// Check if element exists before initializing flatpickr
var dashDateRange = $("#dash-daterange");
